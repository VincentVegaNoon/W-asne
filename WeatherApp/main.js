...
// const weatherApi =
//   "https://api.open-meteo.com/v1/forecast?latitude=52.2298&longitude=21.0118&hourly=temperature_2m,rain,is_day&daily=weathercode,temperature_2m_max,apparent_temperature_max&current_weather=true&timezone=Pacific%2FAuckland";
// const days = {
//   0: "Sunday",
//   1: "Monday",
//   2: "Tuesday",
...
const timeFunc = (number = 0) => {
  const now = new Date();
  let day = days[(now.getDay() + number) % 7];
  return day;
};
